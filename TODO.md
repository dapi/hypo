...
* [x] 5. Если после ввода некорректного пароля обновить страницу - получим 404. https://t.me/c/2182995616/18/10084
...
4. [ ] API для получения сведений о service, project_extension

## Bugs

* [ ] Websocket соединение пропадает
* [x] Не отмечается нода как ошибочная если anvil не смог запуститься из-за
  ошибок в параметрах
